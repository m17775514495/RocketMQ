...
@Log4j2
@Configuration
public class OrdinaryConsumer extends DefaultConsumerConfigure implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent arg0) {
        try {
            super.listenerProperties(messageTypeConfig.getOrdinary(),messageTypeConfig.getOrdinary(), MessageModel.BROADCASTING);

...
@Log4j2
@Configuration
public class SOSConsumer extends DefaultConsumerConfigure implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent arg0) {
        try {
            super.listenerProperties(messageTypeConfig.getSos(),messageTypeConfig.getSos(), MessageModel.BROADCASTING);
